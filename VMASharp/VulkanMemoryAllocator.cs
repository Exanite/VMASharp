...
public sealed unsafe class VulkanMemoryAllocator : IDisposable
{
    ...
    /// Unless specified otherwise with <seealso cref="AllocationCreateFlags.DontBind"/>, the Image will be bound to the memory
    /// for you.
    /// </summary>
    ...
    {
        return pool.BlockList.MakePoolAllocationsLost(CurrentFrameIndex);
    }
